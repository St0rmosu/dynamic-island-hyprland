...
Rectangle {
    ...
    color: Qt.rgba(12/255, 14/255, 20/255, 0.90)
    border.width: 1
    ...
    y: targetCapsule ? Math.round(targetCapsule.y + targetCapsule.height + 10) : 0
    ...
    Rectangle {
        ...
        // Posizionamento verso l'alto (UPWARDS) o verso il basso a seconda dello spazio
        x: {
